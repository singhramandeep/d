...
public final class PriceCheckWorker_Factory {
  ...
  public PriceCheckWorker get(Context appContext, WorkerParameters workerParams) {
  ...
  public static PriceCheckWorker newInstance(Context appContext, WorkerParameters workerParams,
      ProductRepository repository) {
    return new PriceCheckWorker(appContext, workerParams, repository);
  }
}
