...
public final class PriceHistoryDao_Impl implements PriceHistoryDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteHistoryForProduct;
  ...
  public PriceHistoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__preparedStmtOfDeleteHistoryForProduct = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
  ...
  @Override
  public Object insertPriceRecord(final PriceHistory priceHistory,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfPriceHistory.insert(priceHistory);
  ...
  @Override
  public Object deleteHistoryForProduct(final long productId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteHistoryForProduct.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfDeleteHistoryForProduct.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Flow<List<PriceHistory>> getHistoryForProduct(final long productId) {
    final String _sql = "SELECT * FROM price_history WHERE productId = ? ORDER BY timestamp ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, productId);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"price_history"}, new Callable<List<PriceHistory>>() {
      @Override
      @NonNull
      public List<PriceHistory> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new PriceHistory(_tmpId,_tmpProductId,_tmpPrice,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getHistoryListForProduct(final long productId,
